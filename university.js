(function universityIIFE() {
	...
	const $firstSection = document.querySelector(".long-page__image-text");
	const $secondSection = document.querySelector(".long-page__video-heading");
